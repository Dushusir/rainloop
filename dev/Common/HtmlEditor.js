...
import { addUniver, initDialog } from './docs'
...
class HtmlEditor {
	...
	init() {
		if (this.element && !this.editor) {
			...
			// add univer
			this.editor.addCommand("sheet", {
				exec: function(edt) {
					console.log(edt.element.$.querySelector('.cke_editable'));
					addUniver(edt.element.$.querySelector('.cke_editable'),"sheet")
				}
			});
			// add univer
			this.editor.addCommand("doc", {
				exec: function(edt) {
					addUniver(edt.element.$.querySelector('.cke_editable'),"doc")
				}
			});
			// add univer
			this.editor.addCommand("slide", {
				exec: function(edt) {
					addUniver(edt.element.$.querySelector('.cke_editable'),"slide")
				}
			});
			this.editor.ui.addButton('sheet', {
				label: 'Sheet',
				command: 'sheet',
				toolbar: 'insert',
				icon: '../css/images/sheet.svg'
			});
			this.editor.ui.addButton('doc', {
				label: 'Doc',
				command: 'doc',
				toolbar: 'insert',
				icon: '../css/images/doc.svg'
			});
			this.editor.ui.addButton('slide', {
				label: 'Slide',
				command: 'slide',
				toolbar: 'insert',
				icon: '../css/images/slide.svg'
			});
		}
	}
