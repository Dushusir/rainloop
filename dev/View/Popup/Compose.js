...
class ComposePopupView extends AbstractViewNext {
	...
	editor(fOnInit) {
		if (fOnInit) {
			// // remove
			// const univerEles = this.composeEditorArea().querySelectorAll('.univer');
			// Array.prototype.slice.call(univerEles).forEach((univerEle) => {
			// 	univerEle.parentNode.removeChild(univerEle);
			// });
			...
			// this.composeEditorArea().appendChild(div);

			// this.initUniverDoc(div);
			// return;
